...
int main( void ){	
   ...
   if( 0 ){
       hwlib::cout << hwlib::endl << hwlib::endl << "sos" << hwlib::endl;
       rtttl_play( p, sos ); }
   if( 0 ){
       hwlib::cout << hwlib::endl << hwlib::endl << "Let It Be" << hwlib::endl;
       rtttl_play( p, let_it_be );  }
   if( 0 ){
       hwlib::cout << hwlib::endl << hwlib::endl << "muppets" << hwlib::endl;
       rtttl_play( p, muppets );  }
   if( 1 ){
       hwlib::cout << hwlib::endl << hwlib::endl << "rickroll" << hwlib::endl;
       rtttl_play( p, rickroll );  }
   if( 0 ){
       hwlib::cout << hwlib::endl << hwlib::endl << "one" << hwlib::endl;
       rtttl_play( p, one );  }
}
